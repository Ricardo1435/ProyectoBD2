        ...
        <div class="container md mt-2 col-lg-5">
            <div class="card border-info">
                <div class="card-header bg-info text-white">
                    <center><h2 class="mt-2 mb-2"> AGREGAR VEHÍCULO &nbsp;&nbsp;&nbsp;<i class="fas fa-pen-alt"></i></h2> </center>
                </div>
                <div class="card-body">
                    <form action="ControladorVehiculo" method="POST">
                        <div>
                            <input type="text" name="ingresoIdVehiculo" class="form-control" autocomplete="off" placeholder="" maxlength="25" value="" hidden> 
                        </div>
                        <div>
                            <b><label for="ingresoMatricula" class="mt-2">MATRICULA</label></b>
                            <input type="text" class="form-control" autocomplete="off" name="ingresoMatricula" maxlength="25" required>
                        </div>
                        <div>
                            <b><label for="ingresoAliasVehiculo" class="mt-2">ALIAS</label></b>
                            <input type="text" class="form-control" autocomplete="off" name="ingresoAliasVehiculo" required maxlength="75"> 
                        </div>
                        <div>
                            <b><label for="ingresoCantidadAsientos" class="mt-2">ASIENTOS</label></b>
                            <input type="number" class="form-control" autocomplete="off" min="1" pattern="^[0-9]+" name="ingresoCantidadAsientos" required>
                        </div>
                        <div>
