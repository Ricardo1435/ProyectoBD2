...
<html>
    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class="nav-link">Aumentar Sueldos <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container md mt-2 col-lg-6">
            <div class="card border-info">
                <div class="card-header bg-info text-white">
                    <center><h2 class="mt-2 mb-2"> AUMENTO DE SUELDOS </h2> </center>
                </div>
                <div class="card-body">
                        <center>
            ...
            <form action="ControladorConductor" method="POST">
                <button class="btn btn-secondary" id="new" type="submit" name="accion" value="Volver"><i class="fa fa-arrow-left " aria-hidden="true"></i></button>
            </form>
        </div>
    </body>
</html>