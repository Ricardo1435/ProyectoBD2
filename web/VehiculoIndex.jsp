...
<html>
    ...
    <body>
        ...
        <div class="card border-info">
            ...
            <div class="navbar">
                <a class="btn btn-light btn-bg my-3 mx-1" id="new" name="accion" value="Nuevo" href="AddVehiculo.jsp">Nuevo</a>
        ...
        <div class="p-4">
            <table class="table table-striped table-bordered m-auto">
                ...
                <tr>
                    <th colspan="4"><h5><center>VEHICULO</center></h5></th>
                    ...
                    <c:forEach var="dato" items="${datos}">
                        <tr>
                            ...
                            <center> 
                                ...
                                <input type="hidden" id="idVehiculo" name="idVehiculo" value="${dato.getIdVehiculo()}">
                                <button class="btn btn-warning" type="submit" name="accion" value="Editar">Editar&nbsp;<i class="fas fa-edit"></i></button>
                                <button class="btn btn-danger" type="submit" name="accion" value="Eliminar" id="btnEliminarVehiculo">Eliminar&nbsp;<i class="fas fa-trash-alt"></i></button>
                                </form>
                            </center>    
                            </td>
                        </tr>
