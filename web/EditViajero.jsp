        ...
        <div class="container mt-4 mb-4 col-lg-5">
            <div class="card border-info">
                <div class="card-header bg-info text-white">
                    <center><h2 class="mt-2 mb-2"> EDITAR VIAJERO &nbsp;<i class="fas fa-user-edit"></i></h2> </center>
                </div>
                <div class="card-body">
                    <form action="ControladorViajero" method="POST">       
                        ...
                        <div>
                            ...
                            <input type="number" class="form-control" autocomplete="off" name="ingresoAsiento" min="1" pattern="^[0-9]+" placeholder="En números" value="${viajero.getAsiento()}" required>
                        </div>
                        <div>
                            <b><label for="ingresoPesoEquipaje" class="mt-2">PESO EQUIPAJE (libras)</label></b>
                            <input type="number" class="form-control" autocomplete="off" name="ingresoPesoEquipaje" step="0.01" min="1" placeholder="En números" value="${viajero.getPesoEquipaje()}"  required>
                        </div>
                        <div>
