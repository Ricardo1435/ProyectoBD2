            ...
            <div class="card border-info">
                ...
                <div class="card-body">
                    <form action="ControladorCliente" method="POST">
                        <div>
                            <input type="text" name="ingresoIdCliente" class="form-control" autocomplete="off" placeholder="" maxlength="25" value="" hidden> 
                        </div>
                        <div>
                            <b><label for="ingresoDpiCliente" class="mt-2">DPI</label></b>
                            <input type="text" name="ingresoDpiCliente" class="form-control" autocomplete="off" placeholder="" maxlength="25" required> 
                        </div>
                        <div>
                            <b><label for="ingresoNombresCliente" class="mt-2">NOMBRES</label></b>
                            <input type="text" name="ingresoNombresCliente" class="form-control" autocomplete="off" placeholder="" maxlength="75" required> 
                        </div>
                        <div>
                            <b><label for="ingresoApellidosCliente" class="mt-2">APELLIDOS</label></b>
                            <input type="text" name="ingresoApellidosCliente" class="form-control" autocomplete="off" placeholder="" maxlength="75" required>
                        </div>
                        <div>
                            <b><label for="ingresoEdadCliente" class="mt-2">EDAD</label></b>
                            <input type="number" name="ingresoEdadCliente" class="form-control" autocomplete="off"  min="1" pattern="^[0-9]+" placeholder="En números" required>
                        </div>
