    ...
    <body>
         ...
         <div class="container md mt-2 col-lg-5">
            <div class="card border-info">
                <div class="card-header bg-info text-white">
                    <center><h2 class="mt-2 mb-2"> AGREGAR VIAJERO &nbsp;<i class="fas fa-pen-alt"></i></h2> </center>
                </div>
                <div class="card-body">
        <!-- Formulario -->
        <form action="ControladorViajero" method="POST">
            ...
            <div>
                ...
                <input type="number" class="form-control" autocomplete="off" name="ingresoAsiento" min="1" pattern="^[0-9]+" placeholder="En números" required>
            </div>
            <div>
                <b><label for="ingresoPesoEquipaje" class="mt-2">PESO EQUIPAJE (libras)</label></b>
                <input type="number" class="form-control" autocomplete="off" name="ingresoPesoEquipaje" step="0.01" min="1" placeholder="En números" required>
            </div>
            <div>
